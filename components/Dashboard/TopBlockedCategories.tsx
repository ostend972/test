...
import { getTopBlockedDomains } from '../../services/api';
import { Card } from '../ui/Card';
import { TopBlockedDomain, BlockReason } from '../../types';

const ThreatTypeBadge: React.FC<{ type: BlockReason }> = ({ type }) => {
    const colors: Record<BlockReason, string> = {
...
export const TopThreats: React.FC = () => {
