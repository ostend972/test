...
import { getWhitelist, addWhitelistDomain, deleteWhitelistDomain, importWhitelist, exportWhitelist } from '../../services/api.js';
...
export const WhitelistManager = () => {
    ...
    const { data: whitelist, isLoading, isError, error } = useQuery({
        queryKey: ['whitelist'],
        queryFn: getWhitelist,
    });

    const addMutation = useMutation({
        mutationFn: (domain) => addWhitelistDomain(domain),
        onSuccess: () => {
