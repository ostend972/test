...
import { getBlocklist, addBlocklistDomain, deleteBlocklistDomain, importBlocklist, exportBlocklist } from '../../services/api.js';
import { Card } from '../ui/Card.jsx';
import { DomainTable } from './DomainTable.jsx';
import { Button } from '../ui/Button.jsx';

const ConfirmationModal = ({ isOpen, onClose, onConfirm, domainName, isLoading, title, message }) => {
...
export const BlocklistManager = () => {
    ...
    const { data: blocklist, isLoading, isError, error } = useQuery({
        queryKey: ['blocklist'],
        queryFn: getBlocklist,
    });

    const addMutation = useMutation({
        mutationFn: (domain) => addBlocklistDomain(domain),
        onSuccess: () => {
    ...
    const exportMutation = useMutation({
        ...
        onError: (exportError) => alert(`Erreur d'exportation: ${exportError.message}`),
    });
    ...
    const importMutation = useMutation({
        ...
        onError: (importError) => alert(`Erreur d'importation: ${importError.message}`),
    });
